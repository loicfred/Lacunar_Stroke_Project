...
# Since app.py is in Lacunar_Stroke_Project/web/app.py
# and models/ is in Lacunar_Stroke_Project/models/
# We need to go up ONE level from web/ to find models/

# Get the directory where app.py is located
WEB_DIR = os.path.dirname(os.path.abspath(__file__))  # This gives .../Lacunar_Stroke_Project/web/
print(f"📍 Web directory: {WEB_DIR}")

# Go up one level to project root
PROJECT_ROOT = os.path.dirname(WEB_DIR)  # This gives .../Lacunar_Stroke_Project/
...
# List files in models directory to verify
